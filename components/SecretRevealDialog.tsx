...
/**
 * Affiche UNE SEULE FOIS un secret (code PIN temporaire, mot de passe…).
 *
 * Le secret ne vit que dans le state React du parent, qui le vide à la
    ...
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center p-4 py-6 overflow-y-auto">
      ...
      >
        <div className="flex items-center gap-2 mb-1">
          ...
          <h2 id={titleId} className="font-sora text-lg font-black text-gray-900">
            {title}
          </h2>
        </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-gray-50 px-4 py-4 text-center">
          <p className="font-mono text-2xl sm:text-3xl font-bold tracking-widest text-gray-900 select-all break-all">
            {secret}
          </p>
        </div>
