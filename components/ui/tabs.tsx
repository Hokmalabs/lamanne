...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl bg-lamanne-light p-1 text-lamanne-primary",
      className
    )}
    {...props}
  />
