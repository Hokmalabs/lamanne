...
export default async function ClientDetailPage({
  ...
  // Verify this client belongs to the commercial
  ...
  if (!client || client.assigned_commercial !== user.id) {
    notFound();
  }

  // Get active cotisations with product info
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6">
        <div className="flex items-center gap-4">
          ...
          <div className="ml-auto">
            <Link
              href={`/commercial/clients/${clientId}/nouvelle-cotisation`}
              className="inline-flex items-center gap-2 bg-lamanne-primary text-white px-4 py-2 rounded-xl text-sm font-semibold hover:bg-lamanne-primary/90 transition-colors"
            >
      ...
      <div>
        <h2 className="font-bold text-gray-900 mb-3">
          Cotisations actives ({cotisations.length})
        </h2>
